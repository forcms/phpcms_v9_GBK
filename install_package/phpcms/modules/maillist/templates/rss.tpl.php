        ...
        <table border="0" cellpadding="1" cellspacing="1"
            ...
            <tr>
                <td><table width="100%" border="0" cellspacing="0"
                        ...
                        <tr class="table_form">
                            <td height="59">&nbsp;</td>
                            <td style="padding-bottom: 10px"><b><?php echo L('rss_source')?>£º</b><br />
                        ...
                        <tr class="table_form">
                            <td valign="top">&nbsp;</td>
                            <td valign="top"><b><?php echo L('rss_url')?>£º</b><br>
                        ...
                        <tr class="table_form">
                            ...
                            <td style="line-height: 24px"><b><?php echo L('rss_rate')?>£º</b><br />
                    <?php echo L('rss_rate_option')?>£º
                    ...
                    <?php echo L('rss_number_option')?>£º
                        ...
                        <tr class="table_form">
                            ...
                            <td><br /> <input type="submit"
                                ...
                                <div
                                    ...
                                    <p>
                                        <strong><?php echo L('rss_tips1')?>£º</strong>
                                    </p>
