 ...
 * 
 * Encoding:    GBK
 * Created on:  2012-4-16-ÏÂÎç5:48:04
 * Autdor:      kangyun
            ...
            <tr class="table_form">
                ...
                <td><div
				  ...
				  <?php echo L('base')?>
                      ...
                      <br />
                    <?php echo L('subscribe_count')?>£º<font
                            color="#2279D4"><?php echo $row['brief_info']['base_total_account']?></font><?php echo L('p')?>   <?php echo L('unsubscribe_count')?>£º<font
                            color="#2279D4"><?php echo $row['brief_info']['base_total_unsubscriber']?></font><?php echo L('p')?>   <?php echo L('theme')?>£º<font
                            color="#2279D4"><?php echo $row['brief_info']['base_total_issued']?></font><?php echo L('a')?>   <?php echo L('send_count')?>£º<font
...
<?php echo L('week_add_user')?>£º<font color="#2279D4"><?php echo $row['brief_info']['weekly_new_account']?></font><?php echo L('p')?>   <?php echo L('week_unsubscribe_user')?>£º<font
                            color="#2279D4"><?php echo $row['brief_info']['weekly_unsubscriber']?></font><?php echo L('p')?>   <?php echo L('week_theme')?>£º<font
            ...
            <tr class="table_form">
                ...
                <td><b><?php echo L('batch_import')?>£º</b></td>
            </tr>
            <tr class="table_form">
