...
<table width="100%" class="table_form ">
 <tr>
     <th><?php echo L('add_category_types');?>£º</th>
      <td>
...
<table width="100%" class="table_form ">
	...
	<tr>
      <th><?php echo L('category_urlrules');?>£º</th>
	...
	<tr>
      <th><?php echo L('show_urlrules');?>£º</th>
...
<tr>
      <th><?php echo L('create_to_rootdir');?>£º</th>
      <td>
