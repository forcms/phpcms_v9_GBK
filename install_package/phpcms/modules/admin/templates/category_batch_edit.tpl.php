...
<div id="table-lists" class="table-list" >
	...
	?>
	 ...
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td class="tpl_style"><b><?php echo L('category_index_tpl')?>£º</b><br>
	...
	?>
	 ...
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td class="tpl_style"><b><?php echo L('category_list_tpl')?>£º</b><br>
	...
	?>
	 ...
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td class="tpl_style"><b><?php echo L('content_tpl')?>£º</b><br>
	...
	?>
	 ...
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td><b><?php echo L('workflow')?>£º</b><br><?php echo form::select($workflows_datas,$cat['setting']['workflowid'],'name="setting['.$catid.'][workflowid]"',L('catgory_not_need_check'));?></td>
	<?php
		}
	?>
	 </tr>
	...
	?>
	 ...
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td><b><?php echo L('html_show')?>£º</b><br>
	...
	?>
	 ...
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td><b><?php echo L('show_urlrules')?>£º</b><br>
	...
	?>
	 ...
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td><b><?php echo L('create_to_rootdir')?>£º</b><br>
	...
	<tr>
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td><b><?php echo L('contribute_add_point')?>£º</b><br>
	...
	?>
	 ...
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td><b><?php echo L('default_readpoint')?>£º</b><br>
	...
	?>
	 ...
	 <?php
		foreach($batch_array as $catid=>$cat) {
	?>
		<td><b><?php echo L('repeatchargedays')?>£º</b><br>
