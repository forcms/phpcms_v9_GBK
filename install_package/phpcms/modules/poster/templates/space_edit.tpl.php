...
<tbody>
	...
	<tr id="trPosition" style="display:none;">
        ...
        <?php echo L('left_margin')?>£º<input name='setting[paddleft]' id='PaddingLeft' type='text' size='5' value='<?php echo $setting['paddleft']?>' class="input-text"> px&nbsp;&nbsp;
        <?php echo L('top_margin')?>£º<input name='setting[paddtop]' id='PaddingTop' type='text' size='5' value='<?php echo $setting['paddtop']?>' class="input-text" /> px</div>
        </td>
    </tr>
	<tr id="SizeFormat">
