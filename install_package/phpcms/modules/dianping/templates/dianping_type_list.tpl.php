...
function edit_type(id, name) {
	...
	window.top.art.dialog({title:'ÐÞ¸Ä '+name+' ',id:'edit',iframe:'?m=dianping&c=dianping&a=edit_type&dianpingid='+id,width:'550',height:'350'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;var form = d.document.getElementById('dosubmit');form.click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
} 
</script>
